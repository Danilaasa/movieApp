...
export const ThemeSwitcher = () => {
    ...
    return (
        <div className="theme-switcher" >
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 47.5 47.5" id="sun">
                        <defs>
                            <clipPath id="a">
                ...
                <Switch defaultValue={localStorage.getItem("theme") === "light" ? false : true} onChange={onChange} />
                    <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" id="moon" width="24px" height="24px" x="0" y="0" enableBackground="new 0 0 512 512" version="1.1" viewBox="0 0 512 512">
                        <g>
                            ...
                            <circle cx="285" cy="156" r="44.5" fill="#666865" stroke="#5E5E5D" strokeMiterlimit="10" strokeWidth="4"></circle>
                            <circle cx="385" cy="300" r="21.5" fill="#666865" stroke="#5E5E5D" strokeMiterlimit="10" strokeWidth="4"></circle>
                            <circle cx="166" cy="296.5" r="27.84" fill="#666865" stroke="#5E5E5D" strokeMiterlimit="10" strokeWidth="4"></circle>
                            <circle cx="261.25" cy="272.75" r="14.75" fill="#666865" stroke="#5E5E5D" strokeMiterlimit="10" strokeWidth="4"></circle>
                            <circle cx="151.5" cy="184" r="28" fill="#666865" stroke="#5E5E5D" strokeMiterlimit="10" strokeWidth="4"></circle>
                            <circle cx="297.5" cy="382.501" r="27.5" fill="#666865" stroke="#5E5E5D" strokeMiterlimit="10" strokeWidth="4"></circle>
                            <circle cx="395" cy="213" r="18.5" fill="#666865" stroke="#5E5E5D" strokeMiterlimit="10" strokeWidth="4"></circle>
                            <circle cx="317" cy="216" r="8" fill="#666865" stroke="#5E5E5D" strokeMiterlimit="10" strokeWidth="4"></circle>
